...
const Skills = () => {
  ...
  const skillBadges = [
    { category: "FrontEnd", skills: ["React.js", "Vue.js", "Tailwind CSS", "HTML5", "CSS3"] },
      ...
      <div className="max-w-7xl mx-auto overflow-hidden relative">
        ...
        <div className="flex whitespace-nowrap animate-marquee hover:[animation-play-state:paused] py-4">
          ...
          {[...logos, ...logos].map((logo, index) => (
            <div 
              key={`${logo.name}-${index}`} 
              className="px-8 min-w-[150px] flex justify-center items-center opacity-50 hover:opacity-100 transition-opacity grayscale hover:grayscale-0"
            >
